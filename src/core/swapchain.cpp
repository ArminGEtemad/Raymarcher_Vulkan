...
SwapChainEngine::SwapChainEngine(WindowHandling &window, SetupDevice &device)
...
// swap chain format
VkSurfaceFormatKHR SwapChainEngine::chooseSwapSurfaceFormat(
...
VkPresentModeKHR SwapChainEngine::chooseSwapPresentMode(
...
// swap chain extent
VkExtent2D SwapChainEngine::chooseSwapExtent(
